 ...
 * ```
 */
export function orzVitePlugin(options = {}) {
    let config = null;
    ...
    const mainPlugin = {
        ...
        async config(userConfig, { command }) {
            ...
            pluginManager = new PluginManager(config.orzConfig, root, command === 'serve');
...
// Transform Helpers
// ========================================
function transformOrzFile(code, id) {
...
function transformControllerFile(code, _id) {
